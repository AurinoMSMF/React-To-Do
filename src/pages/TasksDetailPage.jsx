...
function TaskDetailPage() {
  ...
  return (
    <div className="w-screen h-screen bg-green-300 text-center text-medium flex justify-center p-6">
      <div className="h-80 w-96 p-6 space-y-2 text-2xl bg-slate-100 rounded-lg shadow flex flex-col gap-4">
        <h1>Task Details</h1>
        <div
          className="h-15 w-[100%] bg-white rounded-md border border-green-200 outline-green-600 px-4 py-2"
          name="title"
          type="text"
